...
mail ('gebremedhindanait8@gmail.com.', $subject, $body, $from);

header('Location: submit.html'); // replace "thx.html" with the name and path to your actual thank you page